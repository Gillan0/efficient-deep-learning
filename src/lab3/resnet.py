...
def LightResNetCustomDepthWise2():
    return LightResNet(BasicBlockDepthWise, [2, 2, 2])

def LightResNetCustomDepthWise3():
    return LightResNet(BasicBlockDepthWise, [2, 3, 3])
